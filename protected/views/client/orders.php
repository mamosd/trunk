    ...
    <tr class="order-container" style="display:none;">
        ...
        <td colspan="4">
            ...
            <tr>
                ...
                <td>
                    <?php echo CHtml::textField("OrderDetails[".$order->OrderId."][deliveryDate]", $order->DeliveryDate, array('size'=>'10', 'class'=>'readOnlyField editable dpicker', 'tabindex'=>'-1', 'readonly'=>'readonly')); ?>
                </td>
            </tr>
            </table>
